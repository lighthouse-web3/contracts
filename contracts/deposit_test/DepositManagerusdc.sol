...
contract DepositManagerUsdc {
    ...
    function transferAmount(address wallet, uint256 amount) external onlyOwner{
        require( amount <= usdcToken.balanceOf(address(this)));
        usdcToken.transfer(wallet, amount);
    }
